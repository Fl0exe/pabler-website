...
export type AppSettingWhereInput = {
  ...
  allowSignup?: Prisma.BoolFilter<"AppSetting"> | boolean
}
...
export type AppSettingScalarWhereWithAggregatesInput = {
  ...
  allowSignup?: Prisma.BoolWithAggregatesFilter<"AppSetting"> | boolean
}
...
export type AppSettingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "allowSignup", ExtArgs["result"]["appSetting"]>
...
export interface AppSettingFieldRefs {
  ...
  readonly allowSignup: Prisma.FieldRef<"AppSetting", 'Boolean'>
}
